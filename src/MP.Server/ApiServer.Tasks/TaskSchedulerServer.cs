...
namespace ApiServer.Tasks
{
    ...
    public class TaskSchedulerServer : ITaskSchedulerServer
    {
        ...
        public async Task<ResultModel<string>> StartTaskScheduleAsync()
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ResultModel<string>> StopTaskScheduleAsync()
        {
            try
            {
        ...
        /// <param name="tasksQz"></param>
        /// <returns></returns>
        public async Task<ResultModel<string>> PauseTaskScheduleAsync(sys_tasks tasksQz)
        {
            try
            {
                JobKey jobKey = new JobKey(tasksQz.ID, tasksQz.JobGroup);
